...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Body = "Hola $name,\n\nGracias por inscribirte en el curso '$nombre_curso'. Aquí están los detalles del curso:\n\n"
        ...
        $mail->Body = "Un nuevo participante se ha inscrito en el curso. Aquí están los detalles:\n\n"
                    . "Nombre: $name\n"
                    . "Email: $email\n"
                    . "Curso: $nombre_curso\n"
                    . "ID del Curso: $id_curso\n"
